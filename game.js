...
//     };
//     //not sure if this is where the gameover shit goes, i'm assuming it goes before the update function, since i'd put it in the create
...
//     // game.time.events.add(game.rnd.integerInRange(MIN_ENEMY_SPACING, MAX_ENEMY_SPACING), launchGreenEnemy); this is deleted, keeping so I know what was here before hand
...
function preload() {
    ...
    game.load.image('boss', './assets/apocalypse.gif');
}
